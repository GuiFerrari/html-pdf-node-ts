...
exports.generatePdfs = exports.generatePdf = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(options === null || options === void 0 ? void 0 : options.browser)) return [3 /*break*/, 1];
                    browser = options.browser;
                    delete options.browser;
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, puppeteer_1.default.launch({
                        args: args,
                    })];
                case 2:
                    browser = _a.sent();
                ...
                case 4:
                    page = _a.sent();
                    if (!file.content) return [3 /*break*/, 6];
                ...
                case 5:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, page.goto(file.url, {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 5:
                    ...
                    file = files_1[_i];
                    if (!file.content) return [3 /*break*/, 7];
                    template = handlebars_1.default.compile(file.content, { strict: true });
                    result = template(file.content);
                    html = result;
                    return [4 /*yield*/, page.setContent(html)];
                case 6:
                    _g.sent();
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, page.goto(file.url, {
                        waitUntil: "networkidle0",
                    })];
                case 8:
                    _g.sent();
                ...
                case 11:
                    _i++;
                    return [3 /*break*/, 5];
                case 12: return [2 /*return*/, bluebird_1.Promise.resolve(pdfs)
                        .then(function (data) {
                        return __awaiter(this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
